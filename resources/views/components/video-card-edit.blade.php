...
<a href="/dashboard/videos/{{$video['id']}}" class="group flex flex-col shrink-0 gap-2 bg-white/20 p-3 sm:w-96 w-60 h-75 rounded-md hover:border hover:border-blue-800 ">
    <div>
